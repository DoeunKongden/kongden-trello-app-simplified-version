...
/**
  ...
  /**
   * `prisma.emailVerifiedToken`: Exposes CRUD operations for the **EmailVerifiedToken** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more EmailVerifiedTokens
    * const emailVerifiedTokens = await prisma.emailVerifiedToken.findMany()
    * ```
    */
  get emailVerifiedToken(): Prisma.EmailVerifiedTokenDelegate<ExtArgs, { omit: OmitOpts }>;
}
